...
const { WARN_TYPE_ALERT, ERROR_TYPE_ALERT, SUCCESS_TYPE_ALERT, INFO_TYPE_ALERT } = require("../../constants");
...
const createAlertSchema = Joi.object({
  ...
  type: Joi.string()
  .valid(ERROR_TYPE_ALERT, WARN_TYPE_ALERT, SUCCESS_TYPE_ALERT, INFO_TYPE_ALERT)
  .required()
  .messages({
